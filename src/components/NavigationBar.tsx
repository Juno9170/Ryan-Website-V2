  ...
  return (
    <div className="">
      <div className="w-full fixed h-14 py-2 mt-3 px-8">
        <div className="bg-[#EAEAEABF] h-full w-full rounded-full flex justify-between px-4 py-1 shadow-dark-short">
          ...
          <div className="flex justify-between text-[#86887B] relative">
            <div
              className={`transition-all duration-200 ease-out absolute h-full bg-[#C0DCC3] rounded-full ${active ? "bg-black" : "bg-[#C0DCC3]"} ${activeIndex === 0 ? "left-0" : activeIndex === 2 ? "left-full -translate-x-full" : ""}`}
              style={
                activeIndex === 1
                  ? {
            ...
            <a
              href="/"
              className={`flex items-center justify-center px-10 z-10 hover:text-black active:text-white active:delay-0 transition-all duration-200 hover:delay-200 ease-out ${activeIndex === 0 ? "text-black" : ""}`}
              ref={homeButtonRef}
            ...
            <a
              href="/experience"
              className={`flex items-center justify-center px-10 z-10 hover:text-black active:text-white active:delay-0 transition-all duration-200 hover:delay-200 ease-out ${activeIndex === 1 ? "text-black" : ""}`}
            ...
            <a
              href="/contact"
              className={`flex items-center justify-center px-10 z-10 hover:text-black active:text-white active:delay-0 transition-all duration-200 hover:delay-200 ease-out ${activeIndex === 2 ? "text-black" : ""}`}
